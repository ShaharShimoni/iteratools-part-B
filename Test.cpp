//
// Created by shahar on 09/06/2020.
//
...
//    vector<string> answer = {"Hello", "HelloBye", "HelloByeAdam"};
//    count=0;
//    for (auto i: accumulate(vecString) ){  // Hello HelloBye HelloByeAdam
...
//    count=0;
//    for (auto i: accumulate(vecString) ){  // answer -Today  Today_is  Today_is_Tuesday
//        CHECK(answer[count]==i);
//        if(count>0)
//        CHECK(answer[count]!=vecString[count]);
//        count++;
